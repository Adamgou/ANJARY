...
class ReturnPickingInherit(models.TransientModel):
    ...
    def _create_returns(self):
        id_new_picking, picking_type_id = super(ReturnPickingInherit, self)._create_returns()
    ...
    def set_return_values(self, move_lines, related_picking_id):
        ...
        move_line_ids = related_picking_id.move_lines.filtered(
            lambda x: x.product_id.id in move_lines.mapped('product_id').ids)
