...
class Sale(models.Model):
    ...
    car_registration_ids = fields.Many2many(
        comodel_name='stock.production.lot', string='Plaque véhicule')
    ...
    passenger_additive_list_ids = fields.One2many(
        'passenger.list.additive', 'passenger_additive_sale_order_id', string='Liste additive des passagers')
    ...
    def action_sms(self):
        ...
        ctx.update({'default_recipient_single_number_itf': tel_phone,
